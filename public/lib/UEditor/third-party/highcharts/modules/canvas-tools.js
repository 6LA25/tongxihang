...
*/
function RGBColor(m) {
  this.ok = !1; m.charAt(0) == '#' && (m = m.substr(1, 6)); var m = m.replace(/ /g, ''); var m = m.toLowerCase(); var a = {aliceblue: 'f0f8ff',
    antiquewhite: 'faebd7',
    aqua: '00ffff',
    aquamarine: '7fffd4',
    azure: 'f0ffff',
    ...
    whitesmoke: 'f5f5f5',
    yellow: 'ffff00',
    yellowgreen: '9acd32'}; var c; for (c in a)m == c && (m = a[c]); var d = [{re: /^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/, example: ['rgb(123, 234, 45)', 'rgb(255,234,245)'], process: function (b) { return [parseInt(b[1]), parseInt(b[2]), parseInt(b[3])] }}, {re: /^(\w{2})(\w{2})(\w{2})$/,
    example: ['#00ff00', '336699'],
    process: function (b) { return [parseInt(b[1], 16), parseInt(b[2], 16), parseInt(b[3], 16)] }}, {re: /^(\w{1})(\w{1})(\w{1})$/, example: ['#fb0', 'f0f'], process: function (b) { return [parseInt(b[1] + b[1], 16), parseInt(b[2] + b[2], 16), parseInt(b[3] + b[3], 16)] }}]; for (c = 0; c < d.length; c++) { var b = d[c].process; var k = d[c].re.exec(m); if (k)channels = b(k), this.r = channels[0], this.g = channels[1], this.b = channels[2], this.ok = !0 } this.r = this.r < 0 || isNaN(this.r) ? 0 : this.r > 255 ? 255 : this.r; this.g = this.g < 0 || isNaN(this.g) ? 0
...
(b /= 100); return b
      }; this.valueOrDefault = function (b) { return this.hasValue() ? this.value : b }; this.numValueOrDefault = function (b) { return this.hasValue() ? this.numValue() : b }; var b = this; this.Color = {addOpacity: function (d) { var c = b.value; if (d != null && d != '') { var f = new RGBColor(b.value); f.ok && (c = 'rgba(' + f.r + ', ' + f.g + ', ' + f.b + ', ' + d + ')') } return new a.Property(b.name, c) }}; this.Definition = {getDefinition: function () { var d = b.value.replace(/^(url\()?#([^\)]+)\)?$/, '$2'); return a.Definitions[d] },
        isUrl: function () {
          return b.value.indexOf('url(') ==
0
        },
        getFillStyle: function (b) { var d = this.getDefinition(); return d != null && d.createGradient ? d.createGradient(a.ctx, b) : d != null && d.createPattern ? d.createPattern(a.ctx, b) : null }}; this.Length = {DPI: function () { return 96 },
...
(function (m) {
  var a = m.css; var c = m.CanVGRenderer; var d = m.SVGRenderer; var b = m.extend; var k = m.merge; var e = m.addEvent; var f = m.createElement; var g = m.discardElement; b(c.prototype, d.prototype); b(c.prototype, {create: function (a, b, c, d) { this.setContainer(b, c, d); this.configure(a) },
    ...
    configure: function (b) {
      var c = this; var d = b.options.tooltip; var f = d.borderWidth; var g = c.ttDiv; var m = d.style; var p = c.ttLine; var t = parseInt(m.padding, 10); var m = k(m, {padding: t + 'px', 'background-color': d.backgroundColor, 'border-style': 'solid', 'border-width': f + 'px', 'border-radius': d.borderRadius + 'px'}); d.shadow && (m = k(m, {'box-shadow': '1px 1px 3px gray',
        '-webkit-box-shadow': '1px 1px 3px gray'})); a(g, m); a(p, {'border-left': '1px solid darkgray'}); e(b, 'tooltipRefresh', function (d) {

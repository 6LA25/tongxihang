    ...
    >
      ...
      <el-form-item label="楼盘简介：" prop="intro">
        <el-input
          ...
          size="mini"
          resize="none"
          v-model="housesForm.intro"
        ></el-input>
      </el-form-item>
      <el-form-item label="楼盘标签：" prop="tags">
        <el-input
          type="textarea"
          placeholder="多个标签请以英文逗号“,”分开，最多填写3个标签，每个标签不超过5个汉字"
          style="width: 400px"
          size="mini"
          resize="none"
      ...
      <el-form-item label="建筑类型：" prop="buildingType">
        <el-input
          style="width: 400px"
          size="mini"
          v-model="housesForm.buildingType"
        ></el-input>
      </el-form-item>
      <div>
        <div class="ilb-top">
        ...
        <div class="ilb-top">
          <el-form-item label="产权年限：" prop="propertyYears">
            <el-input
              ...
              type="number"
              size="mini"
              v-model="housesForm.propertyYears"
            ></el-input>
      ...
      <div>
        ...
        <div class="ilb-top">
          <el-form-item label="建筑面积：" prop="acreage">
            <el-input
              style="width: 300px"
              placeholder="多个建筑面积请以英文逗号“,”分开"
              size="mini"
              v-model="housesForm.acreage"
            ></el-input>
        ...
        <div class="ilb-top">
          <el-form-item label="总建面积：" prop="zongjianmianji">
            <el-input
              ...
              type="number"
              size="mini"
              v-model="housesForm.zongjianmianji"
            ></el-input>
            <span class="form-label">m2</span>
          </el-form-item>
        </div>
        ...
        <div class="ilb-top">
          <el-form-item label="绿化率：" prop="greetingRate">
            <el-input
              ...
              type="number"
              size="mini"
              v-model="housesForm.greetingRate"
            ></el-input>
        ...
        <div class="ilb-top">
          <el-form-item label="物业公司：" prop="management">
            <el-input
              style="width: 200px"
              size="mini"
              v-model="housesForm.managementCompany"
            ></el-input>
          </el-form-item>
        </div>
        <div class="ilb-top">
          <el-form-item label="物业费用：" prop="management">
            <el-input
              style="width: 150px"
              size="mini"
              v-model="housesForm.managementPrice"
            ></el-input>
        ...
        <div class="ilb-top">
          <el-form-item label="楼面地价：" prop="loumiandijia">
            <el-input
              ...
              type="number"
              size="mini"
              v-model="housesForm.loumiandijia"
            ></el-input>
            <span class="form-label">元/m2</span>
          </el-form-item>
        </div>
      ...
      <div class="ilb-top">
        <el-form-item label="市政基建：" prop="municipalInfrastructure">
          <el-input
            ...
            resize="none"
            size="mini"
            v-model="housesForm.municipalInfrastructure"
          ></el-input>
        </el-form-item>
      </div>
      <div class="ilb-top">
        <el-form-item label="商圈消费：" prop="businessCircle">
          <el-input
            ...
            resize="none"
            size="mini"
            v-model="housesForm.businessCircle"
          ></el-input>
        </el-form-item>
      </div>
      <div class="ilb-top">
        <el-form-item label="交通配套：" prop="transportFacilities">
          <el-input
            ...
            resize="none"
            size="mini"
            v-model="housesForm.transportFacilities"
          ></el-input>
        </el-form-item>
      </div>
      <div class="ilb-top">
        <el-form-item label="周边学校：" prop="aroundSchools">
          <el-input
            ...
            resize="none"
            size="mini"
            v-model="housesForm.aroundSchools"
          ></el-input>
        </el-form-item>
      </div>
      <div class="ilb-top">
      ...
      <el-form-item label="楼盘封面：" prop="coverImg">
        ...
        >
          <img
            v-if="housesForm.coverImg"
            :src="housesForm.coverImg.filepath"
            class="cover-img"
          />
      ...
      <el-form-item label="实景图：" prop="addRealImgs">
        ...
        <div class="form-item-hint-text">
          最多上传6张图片，支持jpg/jpeg/png格式图片，大小不超过1M，建议尺寸：336
          * 256
        </div>
      </el-form-item>
      ...
      <el-form-item label="分享封面图：" prop="shareImg">
        ...
        >
          <img
            v-if="housesForm.shareImg"
            :src="housesForm.shareImg.filepath"
            class="cover-img"
          />
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
        </el-upload>
      ...
      <el-form-item label="楼盘详细地址：" prop="address">
        <el-input
          ...
          style="width: 400px"
          size="mini"
          placeholder="请在此填写详细地址"
          resize="none"
          v-model="housesForm.address"
        ></el-input>
      </el-form-item>
      <el-form-item>
        <div class="form-item-hint-text">
          经纬度查询：
          <el-button type="primary" size="mini" @click="handleCheckInMap"
            >地图查询</el-button
          >
        </div>
        <div
          id="mapContainer"
          style="margin-top: 10px; width: 800px; height: 400px"
        ></div>
        <div style="margin-top: 10px">
          <div style="margin-right: 20px" class="ilb-top">
            经度：<el-input
              disabled
              style="width: 100px"
              size="mini"
              v-model="housesForm.lng"
            ></el-input>
          </div>
          <div class="ilb-top">
            纬度：<el-input
        ...
        <div class="ilb-top">
          <el-form-item label="佣金设置：" prop="revenueCommission">
            <el-input
              ...
              type="number"
              size="mini"
              v-model="housesForm.revenueCommission"
            ></el-input>
            <span
              class="form-label"
              v-if="housesForm.revenueCommissionType !== ''"
              >{{ housesForm.revenueCommissionType ? '元' : '%' }}</span
            >
          </el-form-item>
        </div>
      </div>
      ...
      <el-form-item label="是否支持分销：" prop="distribution">
        <el-radio-group
          v-model="housesForm.distribution"
        ...
        <div class="ilb-top">
          <el-form-item label="3级佣金：" prop="">
            <el-input
              style="width: 100px"
              size="mini"
              v-model="housesForm.level3"
            ></el-input>
            <!-- <span class="form-label" v-if="housesForm.distributionType !== ''">{{housesForm.distributionType ? '元' : '%'}}</span> -->
          </el-form-item>
        </div>
        <div class="warn" style="padding-left: 20px">
      ...
      <el-form-item label="排序：" prop="sort">
        <el-input
          ...
          size="mini"
          type="number"
          v-model="housesForm.sort"
        ></el-input>
        <span class="form-item-hint-text" style="margin-left: 10px"
          >数字越大，优先级越高；如优先级相同，则根据创建时间排序</span
        >
      </el-form-item>
      <el-form-item>
        <el-button
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        hotlineId: [
          { required: true, message: '请选择楼盘驻守', trigger: 'change' },
        ],
        region: [
          { required: true, message: '请选择楼盘所属区域', trigger: 'change' },
        ],
  ...
  mounted() {
    ...
    if (
      this.$route.query.tag === 'edit' ||
      this.$route.query.tag === 'preview'
    ) {
      this.getHouseaItem()
      // this.fetchUsers()
    }
  ...
  methods: {
      ...
      fetchHouseItem({ id: this.$route.query.id })
        .then(({ data }) => {
          Object.keys(this.housesForm).forEach((item) => {
            ...
            } else if (item === 'hotlineId' && data.hotlineObject) {
    ...
    removeRealImg(file, fileList) {
      ...
      if (!this.$route.query.tag) {
        ...
        if (
          !file.response &&
          !this.housesForm.delRealImgs.includes(file.name)
        ) {
    ...
    removeRenderImg(file, fileList) {
      ...
      if (!this.$route.query.tag) {
        ...
        if (
          !file.response &&
          !this.housesForm.delRenderImgs.includes(file.name)
        ) {
    ...
    removeAmbitusImg(file, fileList) {
      ...
      if (!this.$route.query.tag) {
        ...
        if (
          !file.response &&
          !this.housesForm.delAmbitusImgs.includes(file.name)
        ) {

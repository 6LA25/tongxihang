    ...
    <el-form :rules="rules" ref="followingForm" :model="followingForm" label-width="130px">
      ...
      <template v-if="followingForm.followStatus === 6">
        ...
        <el-form-item label="合同金额：" prop="contractAmount">
          <el-input style="width: 400px" type="number" size="mini" v-model="followingForm.contractAmount"></el-input>
        </el-form-item>
...
export default {
  ...
  mounted () {
    this.followingForm.followTime = `${moment().year()}-${moment().month() + 1}-${moment().date()}`
